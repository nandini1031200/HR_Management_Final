...
import org.nagarro.hrmanager.services.CsvService;
import org.nagarro.hrmanager.services.CsvServiceImpl;
import org.nagarro.hrmanager.services.EmployeeService;
import org.nagarro.hrmanager.services.RegisterEmployee;
...
public class HrController {
	...
	/**
	 * Method to upload the employee Details
	 * 
	 * @author vukkalkernandini
	 *
	 */
	...
	public String uploadEmployeeDetail(@Valid @ModelAttribute("emp") EmployeeModel emp, BindingResult result,Model model) {
		if(flag) {
			if(result.hasErrors()) {
    ...
    @PostMapping("/empedit")
	public String editEmployeeDetail(@Valid @ModelAttribute("emp") EmployeeModel emp, BindingResult result,Model model) {
