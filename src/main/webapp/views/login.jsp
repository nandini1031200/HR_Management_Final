...
<body>
    ...
    <header>
        <h2>HR Login Form <br><br><a href="register" class="btn btn-primary  active" role="button"
    ...
    <div class="container">
		...
		action="signUp" method="post" modelAttribute="hr" class="registerform">
              ...
              <div class="form-group row td">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control textfield" id="userid" name="username" minlength="5" maxlength="50"  placeholder="Enter Username/id" required/>
                </div>
              </div>
  				<br>
